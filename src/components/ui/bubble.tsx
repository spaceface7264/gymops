...
/**
 * shadcn's bubble, vendored 2026-09-05 without its `dark:` classes (there is
 * no dark theme). The framed surface of a conversational line; the row
 * around it is `Message`.
 */
