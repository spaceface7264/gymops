...
/**
 * A 20 px box (6 px corners: on the app's radius ramp `rounded-md` is 10 px,
 * which makes a box this size a circle, and a circle reads as a radio) with a 44 px hit area (the `before:` pseudo-element), so the
