...
- `DESIGN.md` — the visual system: tokens, tones, type, radius, the shared components and their rules. Read it before building or changing any screen.
...
The web app deploys from `main` to Cloudflare Pages (`https://gymops.pages.dev` for the pilot); see README, Deployment.
