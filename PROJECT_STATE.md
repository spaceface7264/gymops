...
**P1-01 to P1-05 and P1-09 done** on branch `phase-1-scaffold`. Next up: **P1-06** (Supabase client, auth provider, protected routes), then P1-07 and P1-08.
...
| P1 Scaffold and auth | 🔄 In progress | P1-01 to P1-05 and P1-09 done. |
